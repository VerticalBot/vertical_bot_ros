...
greenhouses** with harvesting / spraying / scouting missions, and two engineering stacks that turn the simulation
...
Everything is verified by 157 unit / integration tests and 32 published demo scenarios (one per localization
method and vision task), and wired to the outside world through documented ports and contracts
...
npm test             # 157 tests
npm run scenarios    # 32 demo scenarios → docs/scenario-results.md
