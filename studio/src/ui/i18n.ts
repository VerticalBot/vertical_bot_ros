...
const RU: Record<string, string> = {
  ...
  'Robot from library': 'Робот из библиотеки', 'Reference frame': 'Система координат', 'Target (teach)': 'Цель (обучить)', 'Target (at robot TCP)': 'Цель (в TCP робота)', 'Folder': 'Папка', 'Box': 'Параллелепипед', 'Cylinder': 'Цилиндр', 'Sphere': 'Сфера',
